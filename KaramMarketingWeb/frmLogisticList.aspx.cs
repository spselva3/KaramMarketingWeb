...
{
    public partial class frmLogisticList : System.Web.UI.Page
    {
        ...
        public void GetLogisticDashBoard()
        {
            try
            {
                ErrorMsg.Style.Value = "display:none";
                ...
                dtdetails = _Cls.LogisticDashBoard("", "", "", "Pending");
                if (dtdetails != null)
                {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dtdetails = new DataTable();
                dtdetails = _Cls.LogisticDashBoard(UserName, fromdate, Todate, Status);
                if (dtdetails != null)
                {
                    if (dtdetails.Rows.Count > 0)
                    {
