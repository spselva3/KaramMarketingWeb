<%@ Page Title="" Language="C#" MasterPageFile="~/MasterForm.Master" AutoEventWireup="true" CodeBehind="CreateEmail.aspx.cs" Inherits="KaramMarketingWeb.CreateEmail" %>
       ...
       $(function () {
           ...
           $("[id$=txtItemCode]").autocomplete({
               source: function (request, response) {
                   $.ajax({
                       url: '<%=ResolveUrl("~/CreateReservation.aspx/GetItemCode") %>',
                               ...
                               <div class="card-body"  >
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="txtEmail" autocomplete="off" runat="server" placeholder="Enter Mobile number" name="Mobilename" >
                                    </div>
                          ...
                          <div class="card-header border-0">
                               <div class="card-body">
                                   ...
                                   <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="txtName" autocomplete="off" runat="server" placeholder="Enter Last Name" name="Lastname" >
