<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmSessionOut.aspx.cs"
    Inherits="KaramMarketingWeb.frmSessionOut" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
                <a href="Login.aspx" style="font-size: larger; font-style: italic;">Return to Login</a>
            </p>
        </div>
    </form>
</body>
