<%@ Page Title="" Language="C#" MasterPageFile="~/MasterForm.Master" AutoEventWireup="true" CodeBehind="ReservationCreate.aspx.cs" Inherits="KaramMarketingWeb.ReservationCreate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
   ...
   <div class="title">Create Reservation ID</div>
    ...
    <div class="content">
          ...
          <div class="card">
              <div class="table-responsive" style="overflow: scroll; height:200px;">
                         ...
                         <div class="user-details">
                              ...
                              <div class="input-box" >
                                  <asp:Button ID="btnCancel" CssClass="buttonCancel" runat="server" Text="Close" OnClientClick="ClosePupup()" /> 
                              </div>
                              <div class="input-box" >
                                    <asp:Button ID="btnLoadCart" CssClass="buttonAdd float-right" runat="server" Text="Load Cart" OnClick="btnLoadCart_Click" />
                              </div>
                         </div> 
                         ...
                         <div class="user-details">
                              <div class="input-box">
                                  <span class="details">Req. Date</span>
                                     <asp:TextBox ID="txtDemandDate" runat="server" AutoCompleteType="Disabled"  ></asp:TextBox>
                              ...
                              <div class="input-box">
                                   <span class="details">Sales Order</span>
                                   <asp:TextBox ID="txtSalesOrder" runat="server"  AutoCompleteType="Disabled" ReadOnly="false"></asp:TextBox>
        ...
        <div class="button">
            <asp:Button ID="btnGenerate"  runat="server" Text="Generate Reservation ID" OnClick="btnGenerate_Click" />
        </div>
    </div>
  </div>
</asp:Content>
