<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="DashBoardWareHouse.aspx.cs" Inherits="KaramMarketingWeb.DashBoardWareHouse" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="content-header">
                 <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-3">
                            <h5 class="m-0 text-dark">WareHouse DashBoard</h5>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
